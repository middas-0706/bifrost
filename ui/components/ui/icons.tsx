...
export const Icons = {
	...
	teamsIcon: (props: IconProps) => (
		<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="4 4 36 38" width="24" height="24" {...props}>
			...
			/>
			<path
				fill="url(#teamsIconGradientC)"
				fillOpacity=".7"
				d="M7.99988 24c0-3.3137 2.68632-6 6.00002-6h8c3.3137 0 6 2.6863 6 6v12c0 3.3137 2.6863 6 6 6l-16.0001-.0001c-5.5228 0-9.99992-4.4771-9.99992-10z"
			/>
			<path
				fill="url(#teamsIconGradientD)"
				fillOpacity=".7"
				d="M7.99988 24c0-3.3137 2.68632-6 6.00002-6h8c3.3137 0 6 2.6863 6 6v12c0 3.3137 2.6863 6 6 6l-16.0001-.0001c-5.5228 0-9.99992-4.4771-9.99992-10z"
			/>
			<path fill="url(#teamsIconGradientE)" d="M32.9999 18c2.7614 0 5-2.2386 5-5s-2.2386-5-5-5-5 2.2386-5 5 2.2386 5 5 5" />
			<path
				fill="url(#teamsIconGradientF)"
				fillOpacity=".46"
				d="M32.9999 18c2.7614 0 5-2.2386 5-5s-2.2386-5-5-5-5 2.2386-5 5 2.2386 5 5 5"
			/>
			<path
				fill="url(#teamsIconGradientG)"
				fillOpacity=".4"
				d="M32.9999 18c2.7614 0 5-2.2386 5-5s-2.2386-5-5-5-5 2.2386-5 5 2.2386 5 5 5"
			/>
			<path
				fill="url(#teamsIconGradientH)"
				d="M17.9999 16c3.3137 0 6-2.6863 6-6 0-3.31371-2.6863-6-6-6s-6 2.68629-6 6c0 3.3137 2.6863 6 6 6"
			/>
			<path
				fill="url(#teamsIconGradientI)"
				fillOpacity=".6"
				d="M17.9999 16c3.3137 0 6-2.6863 6-6 0-3.31371-2.6863-6-6-6s-6 2.68629-6 6c0 3.3137 2.6863 6 6 6"
			/>
			<path
				fill="url(#teamsIconGradientJ)"
				fillOpacity=".5"
				d="M17.9999 16c3.3137 0 6-2.6863 6-6 0-3.31371-2.6863-6-6-6s-6 2.68629-6 6c0 3.3137 2.6863 6 6 6"
			/>
			<rect width="16" height="16" x="4" y="23" fill="url(#teamsIconGradientK)" rx="3.25" />
			<rect width="16" height="16" x="4" y="23" fill="url(#teamsIconGradientL)" fillOpacity=".7" rx="3.25" />
			<path fill="#fff" d="M15.4792 28.1054h-2.4471v7.466h-2.0648v-7.466H8.52014v-1.6768h6.95906z" />
			<defs>
				<radialGradient
					id="teamsIconGradientA"
					cx="0"
					cy="0"
					r="1"
				...
				<linearGradient id="teamsIconGradientC" x1="20.5936" x2="20.5936" y1="18" y2="42" gradientUnits="userSpaceOnUse">
